...
namespace Kotlib.Objects
{
    ...
    public class Account: INotifyPropertyChanged {
        ...
        public Account(string name, Identity owner) : this() {
            Name = name;
            Owner = owner;
        }
    ...
    public class BankAccount: Account {
        ...
        /// <param name="owner">Identité du propriétaire.</param>
        /// <param name="bankname">Nom de la banque.</param>
        /// <param name="iban">Iban.</param>
        /// <param name="bic">Bic.</param>
        public BankAccount(string name, Identity owner) : base(name, owner) { }
    ...
    public class Paycard: Account {
        ...
        public Paycard(string name, Identity owner, BankCard card) : base(name, owner) {
            Card = card;
        }
    ...
    public class Wallet: Account {
        ...
        public Wallet(string name, Identity owner) : base(name, owner) {
            AllowedCredit = 0.0d;
            InitialAmount = (double)Math.Abs(InitialAmount);
        }
    }
