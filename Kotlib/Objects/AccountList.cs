...
namespace Kotlib.Objects
{
	...
	public class AccountList : ObjectList<Account>
	{
        ...
        public Dictionary<Guid, Dictionary<DateTime, List<IEventAction>>> GetAccountStatements(string directory, List<Guid> accountsId, DateTime startDate, DateTime endDate)
        {
