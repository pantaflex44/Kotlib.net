...
namespace Kotlib.Objects {
    ...
    public class BankCard: Paytype {
        ...
        private (int year, int month) _date = (1970, 1);
        /// <summary>
        ...
        public BankCard(string name) : base(name) { }
    ...
    public class Check: Paytype {
        ...
        public Check(string name) : base(name) { }
    ...
    public class BankDirectDebit: Paytype {
        ...
        /// Constructeurs
        /// </summary>
        public BankDirectDebit() : base() { }
        /// <summary>
        /// Constructeur
        /// </summary>
        /// <param name="name">Nom donné au prélèvement bancaire.</param>
        public BankDirectDebit(string name) : base(name) { }
    ...
    public class DirectTransfer: Paytype {
        ...
        /// Constructeurs
        /// </summary>
        public DirectTransfer() : base() { }
        /// <summary>
        /// Constructeur
        /// </summary>
        /// <param name="name">Nom donné au virement bancaire.</param>
        public DirectTransfer(string name) : base(name) { }
    ...
    public class LocalTransfer: Paytype {
        ...
        /// Constructeurs
        /// </summary>
        public LocalTransfer() : base() { }
        /// <summary>
        /// Constructeur
        /// </summary>
        /// <param name="name">Nom donné au transfert bancaire.</param>
        public LocalTransfer(string name) : base(name) { }
